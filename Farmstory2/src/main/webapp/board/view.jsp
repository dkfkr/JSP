...
<section class="view">
    ...
    <table>
        ...
        <c:if test="${view.file > 0}">
            ...
            <td>
                <a href="${ctxPath}/fileDownload.do?fno=${view.fileDto.fno}">${view.fileDto.oriName}</a>&nbsp;
    ...
    <div>
        <a href="${ctxPath}/delete.do?group=${group}&cate=${cate}&no=${view.no}" class="btnDelete">삭제</a>
        <a href="${ctxPath}/board/modify.do?group=${group}&cate=${cate}&no=${view.no}" class="btnModify">수정</a>
