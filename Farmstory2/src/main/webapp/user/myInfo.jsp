...
<main id="user">
    <section class="myInfo">
        <form action="/Farmsotry2/user/myinfo.do" method="post">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnCheckNick"><img src="/Farmstory2/images/chk_id.gif" alt="중복확인"/></button>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" onclick="zipcode()" ><img src="/Farmstory2/images/chk_post.gif" alt="우편번호찾기"/></button>
            ...
            <div>
                <a href="/Farmstory2/list.do" class="btn btnCancel">목록으로</a>
