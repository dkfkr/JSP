        ...
        <div>
            ...
            <table border="0">
				<c:forEach var="latest" items="${latests1}">
				    <tr>
				        <td>></td>
				        <td><a href="${ctxPath}/board/view.do?group=Croptalk&cate=grow&no=${latest.no}"><c:out value="${latest.title}" /></a></td>
				        <td><c:out value="${latest.rdate}" /></td>
				    </tr>
				</c:forEach>
            </table>
        </div>
        <div>
            ...
            <table border="0">
				<c:forEach var="latest" items="${latests2}">
				    <tr>
				        <td>></td>
				        <td><a href="${ctxPath}/board/view.do?group=Croptalk&cate=school&no=${latest.no}"><c:out value="${latest.title}" /></a></td>
				        <td><c:out value="${latest.rdate}" /></td>
				    </tr>
				</c:forEach>
			</table>
        ...
        <div>
            ...
            <table border="0">
                <c:forEach var="latest" items="${latests3}">
				    <tr>
				        <td>></td>
				        <td><a href="${ctxPath}/board/view.do?group=Croptalk&cate=story&no=${latest.no}"><c:out value="${latest.title}" /></a></td>
				        <td><c:out value="${latest.rdate}" /></td>
				    </tr>
				</c:forEach>
            </table>
    ...
    <div class="info">
        ...
        <div>
            <div id="tabs">
                ...
                <div id="tabs-1">
                    <ul class="txt">
                    	<c:forEach var="latest" items="${latests4}">
                        <li><a href="${ctxPath}/board/view.do?group=Community&cate=notice&no=${latest.no}">· ${latest.title}</a></li>
                        </c:forEach>
                    </ul>
                </div>
                <div id="tabs-2">
                    <ul class="txt">
                    	<c:forEach var="latest" items="${latests5}">
                        <li><a href="${ctxPath}/board/view.do?group=Community&cate=qna&no=${latest.no}">· ${latest.title}</a></li>
                        </c:forEach>
                    </ul>
                </div>
                <div id="tabs-3">
                    <ul class="txt">
                    	<c:forEach var="latest" items="${latests6}">
                        <li><a href="${ctxPath}/board/view.do?group=Community&cate=faq&no=${latest.no}">· ${latest.title}</a></li>
                        </c:forEach>
                    </ul>
                </div>
            </div>
