        ...
        <div id="sub">
            ...
            <section class="croptalk">
                <aside>
                    ...
                    <ul class="lnb">
                        <li><a href="../board/list.do?group=${group}&cate=story">농작물이야기</a></li>
                        <li class="on"><a href="../board/list.do?group=${group}&cate=grow">텃밭가꾸기</a></li>
                        <li><a href="../board/list.do?group=${group}&cate=school">귀농학교</a></li>
                    </ul>
