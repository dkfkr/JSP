...
public final static String SELECT_USER_LATESTS = "SELECT * FROM `User` WHERE `role`='USER' LIMIT ?";
...
public static final String SELECT_MY_INFO        = "SELECT * FROM `User` WHERE `nick`=?";
...
public final static String SELECT_PRODUCT_LATESTS = "SELECT * FROM `Product` LIMIT ?";
// Order
...
public static final String SELECT_ORDERS = "SELECT "
											...
											+ "LIMIT ?, 10";
public final static String SELECT_ORDER_LATESTS = "SELECT "
		+ "a.*,"
		+ "b.`pName`,"
		+ "b.`thumb1` "
		+ "FROM `Order` AS a "
